...
class TestServer(TestCase):
    ...
    def test_handler_client_messages_no_action(self):
        self.assertEqual(handler_client_messages(self.dict_no_action), self.response_error)

    def test_handler_client_messages_no_time(self):
        self.assertEqual(handler_client_messages(self.dict_no_time), self.response_error,
    ...
    def test_handler_client_messages_no_user(self):
        self.assertNotEqual(handler_client_messages(self.dict_no_user), self.response_ok)
